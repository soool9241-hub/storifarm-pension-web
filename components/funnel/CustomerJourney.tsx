const STEPS = [
  {
    ...
    eyebrow: "지금 바로",
    title: "무료 온라인 진단 3분",
    quote: "내 펜션이 네이버에서 몇 번째로 뜨는지 모르겠어요.",
    body: "20문항 체크만 하면 사장님 펜션의 온라인 상태를 A~F 등급으로 진단해드려요. 광고비 한 푼 안 듭니다.",
  ...
  },
  {
    n: "03",
    eyebrow: "14~21일",
    title: "사장님 펜션 홈페이지 완성",
    quote: "에이전시는 비싸고, 무료 템플릿은 펜션에 안 맞아요.",
    body: "달팽이아지트에서 실전 검증한 템플릿 중 하나 고르시면 예약 시스템·SMS 자동화·네이버 광고까지 한 번에 세팅해드립니다.",
